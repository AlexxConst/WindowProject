...
var modals = function modals() {
  ...
  bindModal('.phone_link', '.popup', '.popup_close'); // showModalByTime('.popup', 60000);
};
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.glazing_slider').slick({
    infinite: true,
    slidesToShow: 5,
    slidesToScroll: 1,
    responsive: [{
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.decoration_slider').slick({
    infinite: true,
    slidesToShow: 4,
    slidesToScroll: 1,
    responsive: [{
